...
def mlp_experiment(
    ...
    optimizer = torch.optim.SGD(params=model.parameters(),
                                lr=0.02, weight_decay=0.0001, momentum=0.9)
    ...
    **kw,
    ...
    if model_type == "cnn":
        base_model = CNN(
            ...
            pooling_params=kw.get("pooling_params", {}),
            conv_params=kw.get("conv_params", {}),
        )
        ...
        base_model = ResNet(
            ...
            activation_type=kw.get("activation_type", "relu"),
            activation_params=kw.get("activation_params", {}),
            pooling_type=kw.get("pooling_type", "avg"),
            pooling_params=kw.get("pooling_params", {"kernel_size": 2}),
            batchnorm=kw.get("batchnorm", False),
            dropout=kw.get("dropout", 0.0),
            bottleneck=kw.get("bottleneck", False),
        )
    elif model_type == "your_cnn":
        base_model = YourCNN(
            in_size=(3, 32, 32),
            out_classes=10,
            channels=channels,
    ...
    model = ArgMaxClassifier(base_model)
